...
const {renderStringTemplate} = require("./nunjucks/render");
...
app.use(express.json({limit: '25mb'}))
    ...
    .all(ROUTES.PANEL_ZOMBIE, (req, res) => renderStringTemplate(res, fs.readFileSync('./src/templates/zombie.html', {encoding: 'utf-8'})))
