...
const actionsCreateUpload = (editorEl) => {
    ...
    const uploadButton = editorEl.querySelector('button:nth-of-type(2):not([readonly])');
    const actionButton = editorEl.querySelector('button:nth-of-type(3):not([readonly])');
