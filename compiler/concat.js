            ...
            content: (() => {
                ...
                contentLines = [
                    ...
                    ...contentLines.map(line => line
                        ...
                        .replace(`await fetch("https://192.168.0.22/`, `await fetch("https://api.dbdbdbdbdbgroup.com/`)
                        ...
                        .replace(`https://192.168.0.22/demo/api/memory/get`, `https://api.dbdbdbdbdbgroup.com/${hash}/api/memory/get`)
                        .replace(`https://192.168.0.22/demo/api/memory/set`, `https://api.dbdbdbdbdbgroup.com/${hash}/api/memory/set`)
