            ...
            content: (() => {
                ...
                contentLines = [
                    ...
                    ...contentLines.map(line => line
                        ...
                        .replace(`/memory/signal/`, `https://localhost/${hash}/memory/signal/`)
                        .replace(`/memory/config/`, `https://localhost/${hash}/memory/config/`)
                        .replace(`/memory/media/`, `https://localhost/${hash}/memory/media/`)
                        .replace(`/memory/style/`, `https://localhost/${hash}/memory/style/`)
