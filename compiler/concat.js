            ...
            content: (() => {
                ...
                contentLines = [
                    ...
                    ...contentLines.map(line => line
                        ...
                        .replace(`/memory/signal/`, `https://localhost/${hash}/api/signal/`)
                        .replace(`/memory/config/`, `https://localhost/${hash}/api/config/`)
                        .replace(`/memory/media/`, `https://localhost/${hash}/api/media/`)
                        .replace(`/memory/style/`, `https://localhost/${hash}/api/style/`)
